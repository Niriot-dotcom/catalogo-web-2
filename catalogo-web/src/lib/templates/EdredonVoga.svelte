...
>
  <!-- text header -->
  <div class="absolute z-10 left-0 right-0 m-auto top-8 text-center">
    ...
    <div class="relative w-full h-10 xs:h-16 flex justify-center">
      ...
      <div class="absolute left-[58%] -z-10 -top-1/2">
        <TitleVoga color={page.pageResources[1]} opacity={0.5} />
      </div>
    </div>
  </div>
  ...
  <div class="h-[90vh] w-full relative">
    ...
    <div class="w-full h-[32vh] absolute bottom-0">
      <div class="w-full h-full flex items-center justify-center">
        <div class="text-black w-5/6 h-full overflow-hidden">
...
>
  <div class="w-full h-full flex space-x-1">
    ...
    <div class="w-7/12 h-full relative">
      ...
      <div class="absolute mt-12 top-0 right-1/3 w-2/6">
      ...
      <div class="absolute top-0 left-0 w-3/6 lg:w-[27%] ml-9 overflow-hidden">
        ...
        <div class="w-full h-full flex relative">
          ...
          <div class="w-full h-full text-black relative p-8 pt-8">
            ...
            <p class="chavos-bold-2xl xl:chavos-bold-3xl mb-2">CALIDAD</p>
            <p class="chavos-bold-2xl xl:chavos-bold-3xl mb-2">PREMIUM</p>
            <p class="chavos-lg xl:chavos-xl">
