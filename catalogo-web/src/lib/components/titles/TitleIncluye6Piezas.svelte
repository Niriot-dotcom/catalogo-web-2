<script lang="ts">
  export let bgColor: string = "#c6c6c6";
  export let textColor: string = "#f0f0f0";
</script>
...
>
  <path
    style="fill: {bgColor}"
    d="M144.9,48.6C188.5-1.8,290.6-0.1,373,52.3c46.2,20.3,96.9,91.9,113.1,160c7.7,23.9,5.4,68.4-5.1,99.5
  ...
  <g>
    <path
      ...
      d="M258.1,336.9c17.2,0,31.7-5,43.5-15.1c11.8-10.1,17.7-23.4,17.7-40c0-12.7-2.8-23.4-8.3-32.2
    ...
    <rect
      x="176.9"
      y="68.4"
      transform="matrix(0.8862 -0.4633 0.4633 0.8862 -23.6672 95.236)"
      style="fill: {textColor}"
      width="10.2"
      height="54.7"
    />
    <path
      style="fill: {textColor}"
      d="M169.5,119.8c0.8,2.4,1,4.5,0.7,6.2c-0.3,1.7-1.4,3.3-3.2,4.7c-1.5,1.2-3.2,1.9-5,2.1
    ...
    <rect
      x="71.4"
      y="174.9"
      transform="matrix(0.3601 -0.9329 0.9329 0.3601 -118.4548 186.4092)"
      style="fill: {textColor}"
      width="10.5"
      height="9.2"
    />
    <rect
      x="100"
      y="171.1"
      transform="matrix(0.36 -0.933 0.933 0.36 -110.5135 220.1003)"
      style="fill: {textColor}"
      width="10.2"
      height="39.1"
    />
    <path
      style="fill: {textColor}"
      d="M263.1,109.2c-0.3,0.6-0.7,1-1,1.3c-0.4,0.3-0.9,0.6-1.5,0.7c-0.6,0.1-1.4,0.1-2.4,0l-5.9-0.5l-0.6,7.3
    ...
    <path
      style="fill: {textColor}"
      d="M299.5,109.4c2.3,2.5,5.2,4.4,8.9,5.7c4,1.4,7.7,1.7,11.1,1c3.4-0.7,6.4-2.4,9-5l-6.3-5.2
    ...
    <path
      style="fill: {textColor}"
      d="M120.6,135.3c-2.2-0.3-4.3,0-6.3,1c-2,1-3.7,2.5-5.2,4.6c-1.8,2.5-2.7,5.2-2.9,8.1c-0.1,2.4,0.5,5,1.5,7.7
    ...
    <path
      style="fill: {textColor}"
      d="M208.7,107.9c1.5,1.7,3.2,2.8,5.3,3.4c2.1,0.6,4.4,0.5,7-0.1c2.9-0.7,5.3-2.1,7.3-4.1c1.6-1.7,2.9-4,4-6.6
    ...
    <polygon
      style="fill: {textColor}"
      points="261.2,380.8 250.8,382 251.9,391.2 262.3,390 	"
    />
    <path
      style="fill: {textColor}"
      d="M387,376.4c-0.9-0.9-1.7-1.9-2.6-3.1c-0.1-0.2-0.3-0.4-0.4-0.6l-10.6-13.7c-1.9-2.5-4.1-4.2-6.5-5.1
    ...
    <path
      style="fill: {textColor}"
      d="M239.1,399.8c-2.4-1.6-5.2-2.5-8.6-2.5c-3.2,0-5.9,0.7-8.1,2.1c-1.7,1.1-3.3,2.9-4.8,5l0-6l-9.6-0.1l-0.3,53.2
    ...
    <polygon
      style="fill: {textColor}"
      points="331,408.4 337.8,375.3 335.6,370.8 306.1,385 309.2,391.5 327.4,382.7 320.5,415.8 322.7,420.4 
		353.5,405.5 350.4,399 	"
    />
    <path
      style="fill: {textColor}"
      d="M414.4,344.6c-0.6-2.3-1.9-4.3-3.8-5.8c-1.8-1.5-3.7-2.5-5.6-2.8c-1.9-0.3-3.9,0-6,0.9
    ...
    <rect
      x="255"
      y="396.8"
      transform="matrix(0.9929 -0.119 0.119 0.9929 -47.7 33.9199)"
      style="fill: {textColor}"
      width="10.2"
      height="39.1"
    />
    <path
      style="fill: {textColor}"
      d="M301.6,419.8c-1.1,1.3-2.8,2.3-5.2,3c-1.9,0.6-3.7,0.6-5.3,0c-1.6-0.6-3.1-1.7-4.4-3.6c-1-1.3-1.7-3-2.5-4.9
