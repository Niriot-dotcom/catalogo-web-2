...
<div
  class="fixed top-0 w-full hidden sm:flex sm:items-start justify-between align-top items-baseline"
  style="z-index: 800;"
>
  <!-- Left tab for menu -->
                ...
                <div class="">
                  ...
                  <div class="mt-6 flex flex-col space-y-1">
                    ...
                    >
                      ...
                      <span>Compartir a mi ADI por WhatsApp</span>
                    </button>

                    <!-- svelte-ignore a11y-click-events-have-key-events -->
                    <p
                      class="mt-5 py-2 text-sm text-gray-500"
                    ...
                    >
                      ...
                      #"
                        type="submit"
                        class="text-vianney-600 text-sm underline"
                      >
                        Haz tu pedido desde nuestra página web
                      </a>
                    </p>
