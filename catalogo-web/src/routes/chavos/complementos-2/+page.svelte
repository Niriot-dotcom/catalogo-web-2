...
<!-- entrada -->
<Entrada
  backgroundVideo="../videos/chavos/ENTRADA P7-Complementos.mp4"
  textImage="/images/chavos/copys/Complementos.webp"
  plastaImage="/images/chavos/plastas/FORMA 07.webp"
  storyCopy="-En la sala, todos nos reunimos para jugar juegos de mesa y ver nuestras series de televisión favoritas."
