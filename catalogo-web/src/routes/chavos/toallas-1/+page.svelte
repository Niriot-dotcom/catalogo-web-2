<script lang="ts">
  ...
  const groups: DatabasePage[] = data.props.groupedPages;
</script>
...
<!-- entrada -->
<Entrada
  backgroundVideo="../videos/chavos/ENTRADA P6-Toallas.mp4"
  textImage="/images/chavos/copys/Toallas.webp"
  plastaImage="/images/chavos/plastas/FORMA 06.webp"
  storyCopy="-Mientras el sol se sumergía lentamente en el horizonte, encendimos una fogata en la costa y asamos bombones."
