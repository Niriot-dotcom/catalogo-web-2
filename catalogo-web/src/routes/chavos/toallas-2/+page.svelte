...
<!-- entrada -->
<Entrada
  backgroundVideo="../videos/chavos/ENTRADA P8-Toallas.mp4"
  textImage="/images/chavos/copys/Toallas.webp"
  plastaImage="/images/chavos/plastas/FORMA 08.webp"
  storyCopy="-Organizamos una increíble pool party. La música a todo volumen, el chapoteo en la piscina y las risas fueron interminables."
