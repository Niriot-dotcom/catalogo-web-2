...
<!-- entrada -->
<Entrada
  backgroundVideo="../videos/chavos/ENTRADA P5-Complementos.mp4"
  textImage="/images/chavos/copys/Complementos.webp"
  plastaImage="/images/chavos/plastas/FORMA 05.webp"
  storyCopy="-En mi habitación, Cristy y yo compartimos secretos y planeamos futuros viajes juntas. Decidimos hacer que este verano fuera épico."
