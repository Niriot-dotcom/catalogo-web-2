...
<div
  id="portada"
  data-w-id="daa6ea3e-1745-dd4d-5171-e63e5d2d6b58"
  style="opacity:0"
  class="loader_img-wrap"
>
  <!-- <img
    src="images/chavos/Recurso-2chavos.svg"
    loading="eager"
    style="opacity:0"
    alt=""
  ...
  <div
    ...
    data-video-urls="videos/chavos/PortadaWebChavos24.mp4,videos/chavos/PORTADA-transcode.webm"
    data-autoplay="true"
    data-loop="true"
    data-wf-ignore="true"
  ...
  >
    <video
      ...
      autoplay="true"
      loop="true"
      style="background-image:url(&quot;videos/PORTADA-poster-00001.jpg&quot;)"
      muted="true"
      playsinline="true"
      data-wf-ignore="true"
    ...
    >
      <source
        src="videos/chavos/PortadaWebChavos24.mp4"
        data-wf-ignore="true"
      />
      <source
        src="videos/chavos/PORTADA-transcode.webm"
        data-wf-ignore="true"
      />
    </video>
  </div>
</div>
<!-- <div class="largeee menu-options">
  <div>
    <div>
      <a href="/">
        <div>
          <div class="text-white">Ver Catálogo</div>
        </div>
      </a>
    </div>
  </div>
  ...
  <div class="navigator closed-menu">
    <div class="div-block-15">
      <a
        ...
        id="next"
        href="/chavos/recamara-1"
        class="link-block w-inline-block"
      >
        <div id="next" class="navigator-menu btn-next">
          <div class="text-block-3">Ver Catálogo</div>
          <img src="images/start.svg" loading="eager" alt="" class="image-6" />
        </div>
      </a>
    </div>
  </div>
...
<style>
  .largeee {
    display: none;
    -webkit-transform: translate3d(0, 200px, 0) scale3d(0, 0, 1) rotateX(0)
      rotateY(0) rotateZ(0) skew(0, 0);
    -moz-transform: translate3d(0, 200px, 0) scale3d(0, 0, 1) rotateX(0)
      rotateY(0) rotateZ(0) skew(0, 0);
    -ms-transform: translate3d(0, 200px, 0) scale3d(0, 0, 1) rotateX(0)
      rotateY(0) rotateZ(0) skew(0, 0);
    transform: translate3d(0, 200px, 0) scale3d(0, 0, 1) rotateX(0) rotateY(0)
      rotateZ(0) skew(0, 0);
  }
</style>
