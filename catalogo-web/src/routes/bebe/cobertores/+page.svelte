<script lang="ts">
  ...
  import CobertoresBebe from "$lib/components/communication/CobertoresBebe.svelte";
...
<!-- entrada -->
<EntradaBebe
  backgroundVideo="../videos/bebe/Entrada-P2-Cobertores.mp4"
  backgroundImage="/images/bebe/copys/Entrada-P2-CobertoresFondo.svg"
  backgroundColor="#D2D6EA"
  textImage="/images/bebe/copys/Entrada-P2-Cobertores.svg"
  textColor="#627DB3"
  storyMainPhrase="Las texturas activan sus sentidos"
  storyCopy="y ayudan a darle sensación de calma y calidez."
/>
