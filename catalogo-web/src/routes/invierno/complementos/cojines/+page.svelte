<script lang="ts">
  ...
  import { InviernoComplementosSubsections } from "$lib/constants/subSections";
  ...
  let currentPageRoute = "complementos";
  ...
  let activeTitle = InviernoComplementosSubsections[2].title;
  let activeLink = InviernoComplementosSubsections[2].link;
</script>
