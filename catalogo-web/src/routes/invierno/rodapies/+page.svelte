...
<div style="overflow-x: hidden;">
  {#each products as product, index}
    <div id={product.pageTitle} style="overflow-x: hidden;">
        ...
        <div class="div-block-53">
          ...
          <div class="div-block-43 align-bottom accesorios">
            <div class="page-title-box align-left">
              ...
              >
                {product.pageSubtitle}<br />{product.pageTitle}
              </h2>
              <p
                text-split=""
                words-slide-up=""
                class="paragraph product-detail-subtitle alternate hidden"
                style="max-width: 350px; text-align:left; color: black"
              >
                {product.pageSeoDescription}
              </p>
            </div>
          </div>
        </div>
      ...
      {#if product.pageProductsImages.length > 4}
