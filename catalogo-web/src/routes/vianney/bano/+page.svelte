...
<!-- entrada -->
<EntradaVianney
  backgroundVideo="../videos/vianney/Entrada-P11-Bano.mp4"
  textImage="/images/vianney/Entrada-P11-Bano.svg"
  storyMainPhrase="Texturas que definen cada rincón"
  storyCopy="de la casa, con personalidad y estilo."
  backgroundColor="#f3ecd3"
/>
