...
<!-- entrada -->
<EntradaVianney
  backgroundVideo="../videos/vianney/Entrada-P4-EdredonesNovo.mp4"
  textImage="/images/vianney/Entrada-P4-EdredonesNovo.svg"
  storyMainPhrase="Un espacio que evoluciona con el tiempo"
  storyCopy="pero mantiene la sensación de una familia unida y alegre."
