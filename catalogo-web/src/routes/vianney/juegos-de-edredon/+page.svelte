...
<!-- entrada -->
<EntradaVianney
  backgroundVideo="../videos/vianney/Entrada-P1-JuegosDeEdredon.mp4"
  textImage="/images/vianney/Entrada-P1-JuegosDeEdredon.svg"
  storyMainPhrase="Un hogar puede guardar las historias"
  storyCopy="y momentos que cada miembro de la familia llevará consigo toda su vida."
