...
<!-- entrada -->
<EntradaVianney
  backgroundVideo="../videos/vianney/Entrada-P8-ComedorYSala.mp4"
  textImage="/images/vianney/Entrada-P8-ComedorYSala.svg"
  storyMainPhrase="La cocina de la abuela, ese lugar donde aprendió con sus hermanos las recetas más especiales"
  storyCopy="de su mamá y que ahora le enseñan juntas a sus hijos."
  backgroundColor="#c2ccc4"
/>

<!-- render pages -->
{#each Object.keys(groups) as group, i}
  <!-- {#if group == "Juego de Cocina"} -->
