...
<!-- entrada -->
<EntradaVianney
  backgroundVideo="../videos/vianney/Entrada-P9-Decoracion.mp4"
  textImage="/images/vianney/Entrada-P9-Decoracion.svg"
  storyMainPhrase="En ese hogar se puede ver el avance del tiempo"
  storyCopy="en los colores y formas que decoran el lugar."
  backgroundColor="#b2dde8"
/>
