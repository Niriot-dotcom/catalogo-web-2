...
<!-- entrada -->
<EntradaVianney
  backgroundVideo="../videos/vianney/Entrada-P12-Vialite.mp4"
  textImage="/images/vianney/Entrada-P12-Vialite.svg"
  storyMainPhrase="Este hogar que, generación tras generación, se ha vuelto nuestra pasión."
  storyCopy=""
