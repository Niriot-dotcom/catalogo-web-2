...
<!-- entrada -->
<EntradaVianney
  backgroundVideo="../videos/vianney/Entrada-P10-Cortinas.mp4"
  textImage="/images/vianney/Entrada-P10-Cortinas.svg"
  storyMainPhrase="Donde las texturas"
  storyCopy="pueden despertar una memoria que nos haga sentir calma."
