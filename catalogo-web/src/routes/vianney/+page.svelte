...
<div
  ...
  style="opacity:0"
  class="loader_img-wrap overflow-hidden w-screen h-screen"
>
  <div
    data-poster-url="images/vianney/PortadaVianney24_25.jpg"
    data-video-urls="videos/vianney/Portada-Vianney24-25.mp4,videos/vianney/Portada-Vianney24-25.webm"
    data-autoplay="true"
    data-loop="true"
    data-wf-ignore="true"
  ...
  >
    <video
      ...
      autoplay
      loop
      style="background-image:url(&quot;images/vianney/PortadaVianney24_25.jpg&quot;)"
      muted
      playsinline
      data-wf-ignore="true"
    ...
    >
      <source
        src="videos/vianney/Portada-Vianney24-25.mp4"
        data-wf-ignore="true"
      />
      <source
        src="videos/vianney/Portada-Vianney24-25.webm"
        data-wf-ignore="true"
      />
    </video>
  </div>
  ...
  <div class="navigator closed-menu">
    <div class="div-block-15">
      <a
        ...
        id="next"
        href="/vianney/juegos-de-edredon"
